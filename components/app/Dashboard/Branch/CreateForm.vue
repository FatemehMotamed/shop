      ...
      <form>
        <v-row>
          <v-col cols="12" md="6" lg="6" sm="6">
            <v-text-field color="#3f6ad8" outlined dense label="نام شعبه"  v-model="name"  :error-messages="nameErrors" @input="$v.name.$touch()" @blur="$v.name.$touch()"  required></v-text-field>
          </v-col>
          <v-col cols="12" md="6" lg="6" sm="6">
            <v-text-field color="#3f6ad8"  outlined dense label="شماره تلفن"  v-model="phones"  :error-messages="phonesErrors" @input="$v.phones.$touch()" @blur="$v.phones.$touch()" ></v-text-field>
          </v-col>
        </v-row>
        ...
        <v-row>
          <v-col cols="12" md="12" lg="12" sm="12">
            <v-textarea color="#3f6ad8" rows="3" row-height="25" outlined dense  label="آدرس"  v-model="address"    :error-messages="addressErrors" @input="$v.address.$touch()" @blur="$v.address.$touch()"  ></v-textarea>
          </v-col>

        </v-row>
        <v-row>
          <v-col cols="12" md="6" lg="6" sm="6">
            <v-text-field color="#3f6ad8" outlined dense  label="شماره فکس" v-model="fax"  :error-messages="faxErrors" @input="$v.fax.$touch()" @blur="$v.fax.$touch()"></v-text-field>
          </v-col>
          <v-col cols="12" md="6" lg="6" sm="6">
            <v-text-field color="#3f6ad8" outlined dense  label="کد پستی" v-model="postal_code"    :error-messages="postalErrors" @input="$v.postal_code.$touch()" @blur="$v.postal_code.$touch()"></v-text-field>
          </v-col>
        </v-row>
